    ...
    <section id="Location" className="max-w-full flex flex-col items-center bg-white">
      ...
      <div className="w-full flex flex-col md:flex-row items-center py-7 md:py-14 gap-6 md:gap-14">
        ...
        <div className="flex flex-col items-center md:items-start w-full px-6 md:pl-[7.5rem] md:justify-between gap-6 text-center md:text-left lg:max-w-lg"> 
          ...
          <div className="flex md:flex-col items-center md:items-start w-full  md:px-2 gap-2 md:gap-6 ">
            ...
            <ol className='text-left font-body text-xs md:text-base list-disc font-medium pl-1 md:pl-5 hidden sm:block space-y-3'>
                  <li className=''>Just 10 minutes from RGA Tech Park & Wipro SEZ</li>
                <li className=''>Close to top IT hubs like Bellandur, Marathahalli & Electronic City</li>
                <li className=''>Upcoming Metro Phase 2A to enhance accessibility to key business zones</li>
                <li className=''>Excellent connectivity via Outer Ring Road, ORR–Sarjapur Link Road & NH-44</li>
          ...
          <div className="text-center md:text-left w-fit">
            <Button 
              ...
              onClick={() => window.open("https://maps.app.goo.gl/kSZTAZGKPvtSZPd79", "_blank")} // Opens Google Maps link in a new tab
            />
          </div>
        </div>
              {/* Google Maps Iframe */}
        <div className="w-full flex justify-center">
          ...
          <iframe src=
         "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118288.79949601028!2d77.57167388986457!3d12.911138743294599!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae6f78c3e75109%3A0x65c327b0d8584026!2sThe%20Prestige%20City!5e1!3m2!1sen!2sin!4v1762768744020!5m2!1sen!2sin"
